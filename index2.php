                            ...
                            <div class="col-sm-6">
                                <div class="form-floating">
                                    <select class="form-select" id="cage" name="cage" aria-label="Service Type" required>
                                        ...
                                        <option value="Service 1">AC Installation</option>
                                        <option value="Service 2">AC Maintainance</option>
                                        <option value="Service 3">AC Repair</option>
                                        <option value="Service 4">AC Duct Cleaning</option>
                                        <option value="Service 1">Deep Cleaningh Services</option>
                                        <option value="Service 2">HVAC Air Duct Cleaning Service</option>
                                        <option value="Service 3">Upholstery Sofa Steam Cleaning</option>
                                        <option value="Service 4">Villa & House Cleaning</option>
                                        <option value="Service 1">Water tank Cleaning & Disinfection</option>
                                        <option value="Service 2">Window Glass Cleaning</option>
                                        <option value="Service 3">Mattress Cleaning</option>
                                        <option value="Service 4">Carpet Cleaning</option>
                                        <option value="Service 4">Pool Cleaning</option>
                                    </select>
